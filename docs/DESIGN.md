# Architecture Decision Record - Excel export with pivot tables
...
Implement Excel export with pivot tables using industry-standard patterns appropriate for java and our platform requirements.
